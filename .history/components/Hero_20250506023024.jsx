...
export default function Hero() {
  return (
    <section
      ...
      className="relative w-full min-h-screen bg-gradient-to-br from-[#1f0d3a] via-[#36147f] to-[#6C3FCF] text-white px-4 sm:px-12 py-20 -mt-10 flex items-center justify-center"
    >
