...
export default function Hero() {
  return (
    <section className="w-full  bg-[#6C3FCF] text-gray-100 flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-20 relative overflow-hidden">
      {/* Texto */}
      ...
      >
        <div className="relative w-64 h-64 md:w-80 md:h-80 border-[6px] border-white rounded-xl shadow-2xl overflow-hidden">
          <Image
            src="/assets/yo-franco.png" // <--- Reemplazá este archivo en public/images/
            alt="Foto de Franco"
            fill
