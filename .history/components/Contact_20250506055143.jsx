...
export default function Contact() {
  return (
    <section className="bg-[#1c1c1c] text-white py-20 px-6 flex justify-center">
      <div className="bg-[#753b6c] rounded-xl p-8 md:p-14 w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Texto y enlaces */}
        ...
        <div className="relative w-94 h-64 md:w-72 md:h-72 flex items-center justify-center">
          {/* Nube blanca detrás */}
          <Image
            src="/assets/nube.png" // nube blanca
            alt="Nube decorativa"
            fill
