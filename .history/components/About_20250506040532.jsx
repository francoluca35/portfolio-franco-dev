...
export default function About() {
  return (
    <section className="relative w-full min-h-screen bg-black text-white flex items-center justify-center overflow-hidden">
      {/* Fondo de imagen */}
      <Image
        src="/assets/fondos/fondo-projectos.png" // ← reemplazalo con tu imagen real
        alt="Fondo"
        fill
      ...
      <div className="relative z-20 max-w-6xl px-4 sm:px-8 py-20 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="text-center md:text-left space-y-6 max-w-xl">
          ...
          <motion.a
            href="/cv-parera-franco-luca.pdf" // ← tu CV real aquí
            download
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="inline-block bg-[#8e2df5] text-white font-mono text-lg px-8 py-3 rounded-full shadow-lg border border-white/10 hover:bg-[#7c23d3] transition-all"
          >
            Descargar CV
          </motion.a>
        </div>
