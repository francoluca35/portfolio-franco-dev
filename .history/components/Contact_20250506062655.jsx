...
export default function Contact() {
  ...
  return (
    <section className="bg-[#272626] text-white py-20 px-6 flex justify-center">
      <div className=" bg-gradient-to-br  from-[#0c0713] via-[#3a115d] to-[#131212] rounded-xl p-8 md:p-14 w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Texto y enlaces */}
