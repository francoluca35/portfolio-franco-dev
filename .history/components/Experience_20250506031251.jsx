export default function Experience() { return <section className="my-16">Experiencia (próximamente)</section>; }"use client";
...
const experiences = [
  {
    ...
    description: "Sitios institucionales modernos, optimizados para SEO y completamente responsivos.",
    source: "Clientes independientes",
  },
  {
    title: "Sistemas de Gestión",
    description: "Aplicaciones CRUD, dashboards, administración de usuarios y módulos personalizados.",
    source: "Proyectos freelance",
  },
  {
    title: "Integraciones externas",
    description: "Pasarelas de pago, APIs REST, autenticación con terceros y manejo de bases de datos.",
