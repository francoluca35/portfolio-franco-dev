...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-[#6C3FCF] text-white overflow-hidden flex items-center justify-center">
      {/* Fondo derecho negro */}
      <div className="absolute top-0 right-0 w-full md:w-1/3 h-full bg-[#181818] z-0" />

      {/* Contenido principal */}
      <div className="relative z-10 max-w-7xl w-full flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-20 gap-12 md:gap-0">
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white max-w-xl mx-auto md:mx-0"
          >
            Me especializo en crear productos digitales modernos, escalables y
            con gran experiencia de usuario.
          </motion.p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-8 text-sm text-white/90 max-w-xl mx-auto md:mx-0">
        ...
        <motion.div
          ...
          className="relative flex justify-center items-center w-full md:w-auto"
        >
          {/* Cuadro blanco detrás */}
          <div className="absolute bottom-[-12px] left-[12px] w-64 h-64 md:w-80 md:h-80 border border-white z-0" />
