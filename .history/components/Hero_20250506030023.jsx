  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 max-w-6xl w-full flex flex-col md:flex-row items-center md:items-center md:justify-between gap-10">
        ...
        {/* Texto */}
        {/* Contenedor con efecto de fondo difuminado */}
        <div className="backdrop-blur-md  bg-[#1f0d3a]/30 rounded-xl p-6 md:p-10 shadow-lg border border-white/10">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-center text-[#0fc573] flex justify-center md:justify-start items-center gap-3 flex-wrap"
          >
            Fullstack Developer
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-white max-w-xl mt-4"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/90 max-w-md pt-6"
          >
            <p>
