...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen bg-[#6C3FCF] text-white overflow-hidden flex items-center justify-center px-6 sm:px-12 py-20">
      {/* Fondo negro a la derecha (solo en desktop) */}
      <div className="hidden md:block absolute top-0 right-0 w-1/3 h-full bg-[#181818] z-0" />

      {/* Contenido */}
      <div className="relative z-10 max-w-7xl w-full flex flex-col-reverse md:flex-row items-center md:items-start justify-between gap-12">
        ...
        <div className="text-center md:text-left md:w-1/2 space-y-6">
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-white/90 max-w-xl mx-auto md:mx-0"
          >
            Me especializo en crear productos digitales modernos, escalables y
            con gran experiencia de usuario.
          </motion.p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-white/90 pt-4">
