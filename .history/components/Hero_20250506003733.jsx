...
export default function Hero() {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-[#6C3FCF] text-white">
      {/* Parte derecha verde lima */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-[#D3F56A] z-0" />
