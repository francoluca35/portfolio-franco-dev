...
export default function SkillsSection() {
  const skills = [
    { icon: <FaHtml5 className="text-4xl md:text-7xl" />, name: "HTML5" },
    { icon: <FaCss3Alt className="text-6xl" />, name: "CSS3" },
    { icon: <FaJs className="text-6xl" />, name: "JavaScript" },
    { icon: <SiTailwindcss className="text-6xl" />, name: "Tailwind CSS" },
    { icon: <SiNextdotjs className="text-6xl" />, name: "Next" },
    { icon: <FaReact className="text-6xl" />, name: "React" },
    { icon: <SiRemix className="text-6xl" />, name: "Remix" },
    { icon: <FaGitAlt className="text-6xl" />, name: "Git" },
    { icon: <FaGithub className="text-6xl" />, name: "GitHub" },
    { icon: <BiCodeAlt className="text-6xl" />, name: "RESTful APIs" },
    { icon: <SiFirebase className="text-6xl" />, name: "Firebase" },
  ...
  return (
    <section className="w-full min-h-screen flex items-center bg-[#331770] text-white px-4 sm:px-10">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h2 className="text-6xl sm:text-5xl font-extrabold mb-4">
