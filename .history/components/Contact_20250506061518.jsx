...
export default function Contact() {
  ...
  return (
    <section className="bg-[#272626] text-white py-20 px-6 flex justify-center">
      <div className="bg-gradient-to-br from-[#1f0d3a] via-[#36147f] to-[#6C3FCF] rounded-xl p-8 md:p-14 w-full max-w-6xl flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Texto y enlaces */}
